...
@Component({
  selector: 'app-creative-gallery',
  template: `
    <section id="creative" class="py-20 bg-secondary/30">
      <div class="container mx-auto">
        <div class="flex flex-col md:flex-row-reverse gap-12 items-center">
          ...
          <div class="md:w-1/3 flex justify-center p-4 relative">
            ...
            <img src="src/assets/logos/creative.svg" alt="Creative Logo" class="w-32 h-32 relative z-10 text-text-primary" />
          </div>

          <div class="md:w-2/3">
            <div class="text-center md:text-left mb-8 md:mb-0">
              <h2 class="text-4xl font-bold mb-4 gradient-text">Creative Gallery</h2>
...
export class CreativeGalleryComponent {
  projects: Project[] = [
    { title: 'Art & Craft', url: 'https://ritawebdesigner.wordpress.com/creative-gallery/', description: 'A gallery of my art.' },
    { title: 'Poetry', url: 'https://ritawebdesigner.wordpress.com/my-world/', description: 'A collection of my poems.' },
    { title: 'Tribute', url: 'https://ritawebdesigner.wordpress.com/tribute/', description: 'A special tribute page.' },
  ];
